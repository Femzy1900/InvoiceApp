            ...
            <div class="invoice-work flex flex-column">
                <div class="payment flex">
                    <div class="input flex flex-column">
                        ...
                        <input disabled id="invoiceDate" v-model="invoiceDate" type="text">
                    </div>
                    <div class="input flex flex-column">
                        <label for="paymentDueDate">
                            Payment Due
                        </label>
                        <input disabled id="paymentDueDate" v-model="paymentDueDate" type="text">
                    </div>
                </div>
                <div class="input flex flex-column">
                    ...
                    <select required id="paymentTerms" v-model="paymentTerms" type="text">
                ...
                <div class="input flex flex-column">
                    ...
                    <input required id="clientName" v-model="clientName" type="text">
                </div>
                <div class="input flex flex-column">
                    <label for="productDescription">
                        Product Description
                    </label>
                    <input required id="productDescription" v-model="productDescription" type="text">
                </div>
